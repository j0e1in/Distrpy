...
def main():
    print('Redis-trib', __version__, end=' ')
    print('Copyright (c) HunanTV Platform developers')
    if len(sys.argv) < 2:
        print('Usage:', file=sys.stderr)
        print('    redis-trib.py ACTION_NAME [arg0 arg1 ...]', file=sys.stderr)
        print('Take a look at README for more details:', REPO, file=sys.stderr)
        sys.exit(1)
